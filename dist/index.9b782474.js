...
function createElement() {
    ...
    if (elem.textContent) {
        ...
        msg.textContent = "You haven't entered anytging. Reload the page & try again.";
...
function reactElement() {
    ...
    const elem = React.createElement("ho", {
        id: "heading",
        style: {
            color: "red"
        }
    }, userIP); //heading element can be custom aswell like hr/ui/9h.. anything
    if (userIP != "") {
        ...
        const errorElem = React.createElement("span", {
            class: "error-msg"
        }, errorMsg);
        const errorContainer = React.createElement("div", {
...
//# sourceMappingURL=index.9b782474.js.map
